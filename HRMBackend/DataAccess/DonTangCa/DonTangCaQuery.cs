...
namespace HRMBackend.DataAccess.DonTangCa
{
    public partial class DonTangCaDAO
    {
        ...
        private static (string sql, DynamicParameters param) PaginationQuery(PaginationDonTangCaRequest request)
        {
            // Process data
        ...
        private static (string sql, DynamicParameters param) GetByCodeOrNameQuery(SearchDonTangCaRequest request)
        {
            // Param component
            var param = new DynamicParameters();
            param.Add(":code", RemoveSignUnicodeString(request.Code, true), dbType: DbType.String, direction: ParameterDirection.Input);
