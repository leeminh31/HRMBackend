...
namespace HRMBackend.DataAccess.ChiTietQuyBu
{
    public partial class ChiTietQuyBuDAO
    {
        ...
        private static (string sql, DynamicParameters param) PaginationQuery(PaginationChiTietQuyBuRequest request)
        {
            // Process data
        ...
        private static (string sql, DynamicParameters param) GetByCodeOrNameQuery(SearchChiTietQuyBuRequest request)
        {
            // Param component
            var param = new DynamicParameters();
            param.Add(":code", RemoveSignUnicodeString(request.Code, true), dbType: DbType.String, direction: ParameterDirection.Input);
