...
namespace HRMBackend.DataAccess.HopDong
{
    public partial class HopDongDAO : BaseDAO, IHopDongDAO
    {
        ...
        public async Task<(bool hasValue, Models.HopDong data)> GetByIdAsync(int id)
        {
            // Excute
        ...
        public async Task<(bool isSuccess, Models.HopDong data)> CreateAsync(Models.HopDong airport)
        {
            try
            {
