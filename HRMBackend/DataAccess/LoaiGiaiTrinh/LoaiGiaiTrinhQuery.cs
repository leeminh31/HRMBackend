...
{
    public partial class LoaiGiaiTrinhDAO
    {
        #region Method
        ...
        private static (string sql, DynamicParameters param) CreateQuery(Models.LoaiGiaiTrinh model)
        {
            // Param component
            var param = new DynamicParameters();
        ...
        private static (string sql, DynamicParameters param) PaginationQuery(PaginationLoaiGiaiTrinhRequest request)
        {
            // Process data
        ...
        private static (string sql, DynamicParameters param) GetByCodeOrNameQuery(SearchLoaiGiaiTrinhRequest request)
        {
            // Param component
            var param = new DynamicParameters();
            param.Add(":code", RemoveSignUnicodeString(request.Code, true), dbType: DbType.String, direction: ParameterDirection.Input);
        ...
        private static (string sql, DynamicParameters param) UpdateQuery(Models.LoaiGiaiTrinh model)
        {
            // Param component
            var param = new DynamicParameters();
