...
namespace HRMBackend.DataAccess.DuLieuChamCong
{
    ...
    {
        #region Method
        private static (string sql, DynamicParameters param) GetAllIdVanTayQuery(string manhanvien)
        {
            // Param component
            var param = new DynamicParameters();
            //param.Add(":manhanvien", manhanvien, dbType: DbType.String, direction: ParameterDirection.Input);
            string query = @"SELECT DISTINCT MANHANVIEN, IDVANTAY FROM TBL_DULIEUCHAMCONG";
            return (query, param);
        }
        ...
        private static (string sql, DynamicParameters param) GetByCodeOrNameQuery(SearchDuLieuChamCongRequest request)
        {
            // Param component
            var param = new DynamicParameters();
            param.Add(":code", RemoveSignUnicodeString(request.Code, true), dbType: DbType.String, direction: ParameterDirection.Input);
