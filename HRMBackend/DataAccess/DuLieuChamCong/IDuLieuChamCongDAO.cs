...
namespace HRMBackend.DataAccess.DuLieuChamCong
{
    public interface IDuLieuChamCongDAO
    {
        ...
        /// </summary>
        /// <returns></returns>
        Task<(bool hasValue, Models.DuLieuChamCong data)> GetByIDAsync(string maDuLieuChamCong);
        ...
        Task<(bool hasValue, IEnumerable<Models.DuLieuChamCong> data)> GetAllContractAsync();
        Task<(bool isSuccess, IEnumerable<Models.DuLieuChamCong> data)> UpdateOrInsertListRecordsAsync(IEnumerable<Models.DuLieuChamCong> request);
    }
}
