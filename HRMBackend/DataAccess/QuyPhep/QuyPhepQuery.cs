...
namespace HRMBackend.DataAccess.QuyPhep
{
    public partial class QuyPhepDAO
    {
        ...
        private static (string sql, DynamicParameters param) CreateQuery(Models.QuyPhep model)
        {
            // Param component
            var param = new DynamicParameters();
        ...
        private static (string sql, DynamicParameters param) PaginationQuery(PaginationQuyPhepRequest request)
        {
            // Process data
        ...
        private static (string sql, DynamicParameters param) GetByCodeOrNameQuery(SearchQuyPhepRequest request)
        {
            // Param component
            var param = new DynamicParameters();
            param.Add(":code", RemoveSignUnicodeString(request.Code, true), dbType: DbType.String, direction: ParameterDirection.Input);
        ...
        private static (string sql, DynamicParameters param) UpdateQuery(Models.QuyPhep model)
        {
            // Param component
            var param = new DynamicParameters();
