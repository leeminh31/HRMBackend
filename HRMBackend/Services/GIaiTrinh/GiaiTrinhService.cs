...
namespace HRMBackend.Services.GIaiTrinh
{
    public class GiaiTrinhService : BaseService, IGiaiTrinhService
    {
        ...
        #endregion
        public async Task<BaseResult<IEnumerable<GiaiTrinhResponse>>> GetByEmployeeIdAsync(string maNhanVien, DateTime ngayLamViec)
        {
            ...
            var listGiaiTrinh = await _giaiTrinhDAO.GetGiaiTrinhByDayAsync(request);
