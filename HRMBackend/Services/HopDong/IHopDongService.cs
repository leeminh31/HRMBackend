...
namespace HRMBackend.Services.HopDong
{
    public interface IHopDongService
    {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<BaseResult<HopDongResponse>> GetByIDAsync(string maHopDong);

        Task<BaseResult<IEnumerable<HopDongResponse>>> GetByParamsAsync(string? tenHopDong, string? loaiHopDong);
